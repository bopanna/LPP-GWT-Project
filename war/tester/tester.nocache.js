...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tester" because\n';
  ...
  $wnd.__gwt_activeModules['tester'] = {
    'moduleName' : 'tester',
    'bindings' : function() {
      return {};
    }
 ...
 * "/tester.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tester'].superdevmode = true;

  var expectedSuffix = '/tester.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tester + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tester';
  var devModeSessionKey = '__gwtDevModeSession:tester';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tester/tester.nocache.js';
  ...
  $wnd.__gwt_activeModules['tester'].canRedirect = true;
  $wnd.__gwt_activeModules['tester'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tester?user.agent=' + ua + '&_callback=' + callback;
